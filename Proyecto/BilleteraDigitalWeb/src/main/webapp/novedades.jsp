...
<a href="https://wa.me/51940171614?text=Hola,%20me%20gustaría%20más%20información" 
  ...
  <img src="https://img.icons8.com/color/48/000000/whatsapp--v1.png" 
       ...
       <section class="relative h-screen bg-cover bg-center text-white flex items-center" style="background-image: url('img/novedades.png')">
  ...
  <div class="relative z-10 max-w-4xl ml-32 px-6">
    <h1 class="text-5xl font-bold leading-tight mb-4">
      !Descubre las <br />
      Novedades! <br />
      mantente al dia con las<br />
      ultimas novedades de FaciPago
    </h1>
...
<!-- Nueva sección: Novedades 2025 -->
<section class="py-16 bg-white text-gray-800">
  <div class="bg-[#4B34C3] text-white p-10 rounded-lg max-w-6xl mx-auto mb-12 text-center">
    <h2 class="text-3xl font-bold mb-2">Novedades para 2025</h2>
    <p class="text-lg max-w-3xl mx-auto">
      Estamos preparando grandes innovaciones para ti. Próximamente:
    </p>
  </div>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto px-4">
    <div class="border-l-4 pl-4 border-[#4B34C3]">
      <div class="mb-2 text-[#4B34C3]"><i class="fi fi-rs-mobile text-2xl"></i></div>
      <h3 class="font-bold text-lg">web renovada</h3>
      <p class="text-sm mt-2">Nueva interfaz más intuitiva y funcional para que manejes tu dinero desde cualquier lugar.</p>
    </div>

    <div class="border-l-4 pl-4 border-[#2BB15D]">
      <div class="mb-2 text-[#2BB15D]"><i class="fi fi-rs-shield-check text-2xl"></i></div>
      <h3 class="font-bold text-lg">Seguridad mejorada</h3>
      <p class="text-sm mt-2">Implementación de autenticación biométrica y encriptación avanzada para proteger tus datos.</p>
    </div>

    <div class="border-l-4 pl-4 border-[#3E8E6A]">
      <div class="mb-2 text-[#3E8E6A]"><i class="fi fi-rs-calendar-clock text-2xl"></i></div>
      <h3 class="font-bold text-lg">Nuevas funcionalidades</h3>
      <p class="text-sm mt-2">Herramientas para planificación financiera y recordatorios personalizados.</p>
    </div>

    <div class="border-l-4 pl-4 border-yellow-500">
      <div class="mb-2 text-yellow-500"><i class="fi fi-rs-users text-2xl"></i></div>
      <h3 class="font-bold text-lg">Expansión de servicios</h3>
      <p class="text-sm mt-2">Nuevas alianzas y servicios para ofrecerte más beneficios y facilidades.</p>
    </div>
  </div>
</section>
