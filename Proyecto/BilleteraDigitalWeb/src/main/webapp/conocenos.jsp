...
<a href="https://wa.me/51940171614?text=Hola,%20me%20gustaría%20más%20información" 
  ...
  <img src="https://img.icons8.com/color/48/000000/whatsapp--v1.png" 
       alt="WhatsApp">
        ...
        <section class="relative h-screen bg-cover bg-center text-white flex items-center" style="background-image: url('img/fondonosotros1.png')">
  <!-- Capa oscura para reducir brillo -->
  <div class="absolute inset-0 bg-black bg-opacity-50"></div>

  <!-- Contenido principal -->
  <div class="relative z-10 max-w-4xl ml-32 px-6">
    <h1 class="text-5xl font-bold leading-tight mb-4">
      Únete a nosotros y <br />
      hagamos que la vida <br />
      fluya
    </h1>
    <p class="text-2xl font-semibold mb-6 max-w-xl animate-pulse">
      En <span style="color:#FFD700;">FaciPago</span> nos preocupamos por simplificar el día a día de millones usuarios.
    </p>
    <!-- Botón personalizado -->
    <button
  ...
  <!-- Título con fondo -->
  <div class="bg-[#4B34C3] text-white p-10 rounded-lg flex flex-col md:flex-row justify-between items-center max-w-6xl mx-auto mb-12">
    <div>
      <h2 class="text-3xl font-bold mb-2">Nuestro Propósito</h2>
      <p class="text-lg">Hacer más simple el día a día de las personas para que sigan movilizando sus vidas.</p>
    </div>
    <img src="img/nosotros.jpg" alt="Ilustración" class="w-48 mt-6 md:mt-0" />
  </div>

  <!-- Cuatro tarjetas -->
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto px-4">
    <div class="border-l-4 pl-4 border-[#4B34C3]">
      <div class="mb-2 text-[#4B34C3]"><i class="fi fi-rs-heart text-2xl"></i></div>
      <h3 class="font-bold text-lg">Comprometidos contigo</h3>
      <p class="text-sm mt-2">Escuchamos tus necesidades para ofrecerte soluciones reales y accesibles.</p>
    </div>

    <div class="border-l-4 pl-4 border-[#2BB15D]">
      <div class="mb-2 text-[#2BB15D]"><i class="fi fi-rs-rocket-lunch text-2xl"></i></div>
      <h3 class="font-bold text-lg">Convertimos ideas en acción</h3>
      <p class="text-sm mt-2">Llevamos nuestras metas más allá de lo convencional.</p>
    </div>

    <div class="border-l-4 pl-4 border-[#3E8E6A]">
      <div class="mb-2 text-[#3E8E6A]"><i class="fi fi-rs-party-horn text-2xl"></i></div>
      <h3 class="font-bold text-lg">Crecemos y celebramos juntos</h3>
      <p class="text-sm mt-2">Amamos lo que hacemos y lo compartimos como un equipo unido.</p>
    </div>

    <div class="border-l-4 pl-4 border-yellow-500">
      <div class="mb-2 text-yellow-500"><i class="fi fi-rs-lightbulb-on text-2xl"></i></div>
      <h3 class="font-bold text-lg">Pensamos antes de actuar</h3>
      <p class="text-sm mt-2">Investigamos y analizamos para ofrecer siempre lo mejor.</p>
    </div>
  </div>
</section>
