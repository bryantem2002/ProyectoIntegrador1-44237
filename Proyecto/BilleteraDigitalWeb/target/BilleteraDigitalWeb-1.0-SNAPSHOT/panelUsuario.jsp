        ...
        <div class="relative h-full flex flex-col overflow-y-auto">
            ...
            <nav class="flex-grow px-4">
                <div class="space-y-2">
                    ...
                    <a href="#" class="flex items-center px-6 py-4 rounded-xl transition-all duration-300 hover:bg-white hover:bg-opacity-10 text-white">
                        <div class="w-10 h-10 rounded-lg bg-white bg-opacity-10 flex items-center justify-center">
        ...
        <div class="bg-white shadow rounded-2xl p-6 mb-6">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-3">
                    <button class="px-4 py-2 bg-[#2BB15D] text-white rounded-xl hover:bg-green-600 transition">
