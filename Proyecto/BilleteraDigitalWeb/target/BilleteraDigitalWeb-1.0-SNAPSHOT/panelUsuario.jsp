            ...
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <div class="flex items-center space-x-2">
                        <span id="saldo" class="text-3xl font-bold">••••••</span>
                ...
                <div class="flex space-x-3">
                    <button id="scanQRButton" class="px-4 py-2 bg-[#2BB15D] text-white rounded-xl hover:bg-green-600 transition">
                        <i class="fas fa-qrcode mr-2"></i> Escanear QR
                    </button>
                    <button id="showMyQRButton" class="px-4 py-2 bg-[#4B34C3] text-white rounded-xl hover:bg-indigo-700 transition">
                        <i class="fas fa-qrcode mr-2"></i> Mostrar mi QR
                    </button>
                    <button id="rechargeButton" class="bg-[#2BB15D] text-white px-4 py-2 rounded-lg hover:bg-[#23994e] flex items-center">
                        <i class="fas fa-wallet mr-2"></i> Recargar
                    </button>
                    <button id="transferButton" class="px-4 py-2 bg-[#4B34C3] text-white rounded-xl hover:bg-indigo-700 transition">
