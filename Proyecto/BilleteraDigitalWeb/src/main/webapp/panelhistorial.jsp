...
<body class="bg-gray-50 overflow-x-hidden">
  ...
  <div class="flex justify-between items-center mb-4 border-b border-gray-200 pb-2">
    <h3 class="text-xl font-bold text-gray-800 tracking-wide">📋 Historial de Movimientos</h3>
  </div>

  <!-- Contenedor de movimientos -->
  <div id="listaMovimientos" class="space-y-3">
    <!-- Los movimientos se insertarán dinámicamente aquí -->
  </div>

  <!-- Mensaje de error -->
  <p id="errorMovimientos" class="mt-4 text-sm text-red-500 italic"></p>
</div>
